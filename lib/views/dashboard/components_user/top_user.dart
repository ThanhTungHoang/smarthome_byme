                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      if (widget.typeUser == "Unlimited") {
                        return Text(
                          "Device number: $countDevice /Unlimited",
                          style: const TextStyle(
                              fontSize: 15, fontWeight: FontWeight.w300),
                        );
                      }
                ...
                StreamBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      if (widget.typeUser == "Unlimited") {
                        return Text(
                          "Room number: $countRoom /Unlimited",
                          style: const TextStyle(
                              fontSize: 15, fontWeight: FontWeight.w300),
                        );
                      }
